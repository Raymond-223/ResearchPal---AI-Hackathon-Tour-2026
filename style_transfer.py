...
请改写为规范学术风格（保持原意，只调整表达方式）："""
    ...
    def transfer_for_api(
        ...
        journal_mapping = {
            ...
            "ACL": JournalStyle.ACL,
            "IEEE": JournalStyle.IEEE,
            "Cell": JournalStyle.CELL,
            "Lancet": JournalStyle.LANCET,
            "general": JournalStyle.GENERAL_ACADEMIC
        }
        ...
        return {
            ...
            "rewritten": result.transferred_text,
            "suggestions": result.changes_made
        }
    
    def to_api_response(self, result: TransferResult) -> Dict[str, Any]:
        """转换为API响应格式"""
        return {
            "request_id": str(uuid.uuid4()),
            "rewritten": result.transferred_text,

...
class GrammarChecker:
    ...
    def to_api_response(self, suggestions: List[Suggestion], text: str) -> Dict[str, Any]:
        """
        转换为API响应格式（适配GrammarCheckResponse）
        """
        corrected_text = self.apply_suggestions(text, suggestions)
